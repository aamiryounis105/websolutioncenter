...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto px-6 lg:px-9 py-4 flex items-center justify-between max-w-8xl">
        {/* Logo */}
      ...
      >
        <ul className="flex flex-col gap-4 text-2xl font-medium px-6 py-6 bg-primary text-secondary">
          {[
            { label: "Home", href: "/" },
            { label: "About Me", href: "/about" },
            { label: "Our Services", href: "/services" },
