      ...
      <div className="mx-auto px-6 lg:px-20 py-0 lg:py-24 flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <p className="mb-7 text-lg md:text-xl">
           Providing Custom Web Development, WordPress Solutions, and Expert HTML Email Systems. Over 5 Years of Experience Delivering 500+ Projects on Fiverr & Upwork.
          </p>
...
function AboutMe() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setOffset(window.scrollY * -0.40); // adjust intensity if needed
    };
      ...
      <div className="mx-auto px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="bg-accent p-10 pl-10 lg:pl-28 rounded-3xl text-secondary text-center md:text-left">
          ...
          <p className="text-lg leading-relaxed mb-6">
            I&apos;m Aamir, a Custom Website Developer & WordPress Specialist with 
            over 5 years of experience working with global clients on Fiverr 
            and Upwork.  
            <br /><br />
            I combine modern UI/UX design with clean, scalable development to create 
            websites that look stunning, load fast, and convert better.  
            <br /><br />
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-y-3 w-full mx-auto md:mx-0 text-center md:text-left">
            ...
            <li className="flex items-center gap-2 bg-primary w-fit px-4 py-1 rounded-full mx-auto md:mx-0">
              <span className="text-secondary text-3xl">•</span> WordPress Websites
            </li>
            <li className="flex items-center gap-2 bg-primary w-fit px-4 py-1 rounded-full mx-auto md:mx-0">
              <span className="text-secondary text-3xl">•</span> Email Design
            </li>
            <li className="flex items-center gap-2 bg-primary w-fit px-4 py-1 rounded-full mx-auto md:mx-0">
              <span className="text-secondary text-3xl">•</span> HTML Email Signatures
            </li>
            <li className="flex items-center gap-2 bg-primary w-fit px-4 py-1 rounded-full mx-auto md:mx-0">
              <span className="text-secondary text-3xl">•</span> Signature Generators
            </li>
            <li className="flex items-center gap-2 bg-primary w-fit px-4 py-1 rounded-full mx-auto md:mx-0">
              <span className="text-secondary text-3xl">•</span> Branding & Web Strategy
            </li>
          </ul>
...
function TechStack() {
  const techs = [
    ...
    { name: "JavaScript", icon: "/icons/js-logo.png" },
    { name: "React", icon: "/icons/react-logo.png" },
    { name: "Next.js", icon: "/icons/nextjs-logo.png" },
    { name: "Node.js", icon: "/icons/nodejs-logo.png" },
    { name: "WordPress", icon: "/icons/wordpress-logo.png" },
    { name: "Figma", icon: "/icons/figma-logo.png" },
  ];
  ...
  const milestones = [
    {
      ...
      description: "Began offering custom website and email signature design services on Fiverr and Upwork.",
    },
    {
      year: "2022",
      title: "First 100 Projects",
      description: "Completed over 100 projects, specializing in HTML email signatures and responsive websites.",
    },
    {
      year: "2023",
      title: "Signature Generator Tool",
      description: "Built and launched a custom email signature generator to simplify client workflows.",
    },
    {
      year: "2024",
      title: "Expanded Services",
      description: "Added full-stack development services using React, Next.js, Node.js, and Express.js.",
    },
    {
      year: "2025",
      title: "5+ Years Experience",
      description: "Over 500 projects completed with clients globally, building a strong reputation for quality and reliability.",
    },
  ];
          ...
          {milestones.map((milestone, index) => (
            <div key={milestone.year} className="mb-12 ml-6 relative">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:gap-6">
                <div className="md:w-1/4 font-bold text-lg text-primary">{milestone.year}</div>
                <div className="md:w-3/4">
                  <h3 className="text-xl md:text-2xl mb-2 text-accent">{milestone.title}</h3>
  ...
  const services = [
    {
      ...
      description: "Responsive, modern, and high-converting websites tailored to your brand and business goals.",
      color: "bg-accent",
    },
    {
      title: "WordPress Development",
      description: "Fully functional WordPress sites, themes, and plugins, optimized for speed and SEO.",
      color: "bg-accent",
    },
    {
      title: "Email Design & Signatures",
      description: "HTML email templates and mobile-responsive email signatures for consistent branding.",
      color: "bg-accent",
    },
    {
      title: "Email Signature Generator",
      description: "Custom tools to generate professional signatures for all employees, saving time and effort.",
      color: "bg-primary",
    },
    {
      title: "Branding & Web Strategy",
      description: "Strategic planning to align your web presence with your brand and marketing goals.",
      color: "bg-primary",
    },
    {
      title: "Website SEO",
      description: "On-page and technical SEO strategies to boost your website visibility and search ranking.",
      color: "bg-primary",
    },
  ];
      ...
      <div className="mx-auto px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <h3 className="text-2xl mb-4 text-secondary text-center md:text-left">{service.title}</h3>
              <p className="text-secondary text-center md:text-left">{service.description}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="text-secondary mt-16 lg:mt-24 mb-10">
      <div className="mx-auto px-6 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-2/3 text-center md:text-left">
          ...
          <p className="text-lg">
            Let&apos;s work together to create a website, email signature, or brand strategy that elevates your business. I bring 5+ years of experience in web development, design, and SEO to deliver results that matter.
          </p>
        </div>
